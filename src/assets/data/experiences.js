const experiences = [
  ...
  },
  {
    ...
    desc: [
      ...
      'Success of the tool led to 100% in incremental revenue monthly, with substantial increase in customer base of around 80-100% within a year.',
      'Designed and developed end to end app and acted as the point of contact for all the critical errors.',
    ],
  },
  {
    id: 4,
    ...
    desc: [
      ...
      'Performed indexing on tables to reduce the API response time and optimized the code to fetch the data without getting a timeout error.',
